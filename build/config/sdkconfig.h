...
#define CONFIG_BSP_LCD_SUB_BOARD_NONE 1
#define CONFIG_BSP_LCD_SUB_BOARD_TYPE 0
#define CONFIG_BSP_LCD_RGB_BUFFER_NUMS 3
#define CONFIG_BSP_LCD_RGB_BOUNCE_BUFFER_MODE 1
#define CONFIG_BSP_LCD_RGB_BOUNCE_BUFFER_HEIGHT 10
...
#define CONFIG_LV_PERF_MONITOR_ALIGN_CENTER 1
