...
#include "w_lock_big_open.h"

lv_obj_t* lock_big_open(lv_obj_t *parent)  // Принимаем parent как параметр
{
    ...
    lv_label_set_text(label, "ДОСТУП ОТКРЫТ");
    ...
    lv_img_set_src(img, &lv_im_big_lock_open);
